...
Exploration is how the system encounters novelty. Without it, the system can only exploit what it already knows. Your questions should target gaps in the world model, untested assumptions, or unexplored domains relevant to the system's perpetual goals and values.
